...
dependencies {
    ...
    // Jetpack Compose ja ViewModel
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.6.1") // ViewModelin tuki Composelle
    ...
    implementation("androidx.compose.ui:ui-tooling-preview:1.5.1") // Esikatselu
